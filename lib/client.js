...
try {
    ...
    console.log("MADAM MASK CONNECTED TO HER DATABASE 🩸")
} catch {
 ...
 Void.ev.on('group-participants.update', async(anu) => {
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === "connecting") {
                   console.log("Sussesfuly Conected To WhatsApp ✅");
                }
                if (connection === 'open') {
                    console.log("🤹‍♂️ Installing Imported Plugins...");
                    console.log("🧚‍♀️ MADAM MASK MD NOW WORKING 🧚‍♀️");
...
app.listen(port, () => console.log(`MADAM-MASK Server listening on port http://localhost:${port}!`));
